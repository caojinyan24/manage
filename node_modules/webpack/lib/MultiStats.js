...
class MultiStats {
    ...
    hasErrors() {
        return this.stats.map((stat) = > stat.hasErrors()
    ).
    ...
    hasWarnings() {
        return this.stats.map((stat) = > stat.hasWarnings()
    ).
        reduce((a, b) = > a || b, false
    )
        ;
    ...
    toJson(options, forToString) {
        ...
        ;
        const showVersion = typeof options.version === "undefined" ? jsons.every(j = > j.version
    ) :
        options.version !== false;
        const showHash = typeof options.hash === "undefined" ? jsons.every(j = > j.hash
    ) :
        options.hash !== false;
        jsons.forEach(j = > {
            if(showVersion)
