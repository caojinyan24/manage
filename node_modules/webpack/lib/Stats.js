...
>
typeof optionValue !== "undefined" ? optionValue : fallbackValue;
    ...
    >
        ...
        function fnModule(module) {
            ...
            assets: Object.keys(module.assets || {}),
                issuer
        :
            module.issuer && module.issuer.identifier(),
                issuerId
        :
        ...
        :
            !!module.error,
                errors
        :
            module.errors && module.dependenciesErrors && (module.errors.length + module.dependenciesErrors.length),
                warnings
        :
            module.errors && module.dependenciesErrors && (module.warnings.length + module.dependenciesWarnings.length)
        }
            ;
            if (showReasons) {
                obj.reasons = module.reasons.filter(reason = > reason.dependency && reason.module
            ).
                map(reason = > {
                    const obj = {
        ...
        if (showChunks) {
            obj.chunks = compilation.chunks.map(chunk = > {
                    const obj = {
                        ...
                        size: chunk.mapModules(m = > m.size()
        ).
