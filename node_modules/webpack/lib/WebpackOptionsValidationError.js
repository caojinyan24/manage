...
class WebpackOptionsValidationError extends WebpackError {
    constructor(validationErrors) {
        ...
        this.message = "Invalid configuration object. " +
            ...
            validationErrors.map(err = > " - " + indent(WebpackOptionsValidationError.formatValidationError(err), "   ", false)
    ).
        join("\n");
    ...
    >
        ...
        if (schema.enum) return schema.enum.map(item = > JSON.stringify(item)
    ).
        join(" | ");
