...
class ModuleConcatenationPlugin {
    ...
    apply(compiler) {
        ...
        function setBailoutReason(module, reason) {
            ...
            module.optimizationBailout.push(typeof reason === "function" ? (rs) = > formatBailoutReason(reason(rs))
        :
        ...
        for (const module of modules) {
            ...
            if (nonHarmonyReasons.length > 0) {
                ...
                setBailoutReason(module, (requestShortener) = > {
                    const names = Array.from(importingModules).map(m = > `${m.readableIdentifier(requestShortener)} (referenced with ${Array.from(importingModuleTypes.get(m)).join(", ")})`
            ).
                sort();
    ...
    getImports(module) {
        return Array.from(new Set(module.dependencies
            ...
            // Dependencies are simple enough to concat them
                ...
                d.importDependency === dep && !d.id && !Array.isArray(dep.module.providedExports)
        );
    })
