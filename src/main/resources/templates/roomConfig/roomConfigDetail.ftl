            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form">
                    <fieldset disabled>
                        ...
                        <div class="form-group mno">
                            <label for="inputEmail3" class="col-sm-1 control-label"
                                   style="text-align:left;">所属层级</label>
                            <div class="col-sm-2">
                        ...
                        <div class="form-group mno">
                            <label for="inputEmail3" class="col-sm-1 control-label"
                                   style="text-align:left;">展示名称</label>
                            <div class="col-sm-2">
                                <input type="text" value="${roomConfig.roomName}" name="roomName" id="roomName"
                                       class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group mno">
                            ...
                            <div class="col-sm-2">
                                <input type="text" value="${roomConfig.pPid}" name="pPid" id="pPid"
                                       class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group mno">
                        ...
                        <div class="form-group mno">
                            <label for="inputEmail3" class="col-sm-1 control-label"
                                   style="text-align:left;">更新时间</label>
                            <div class="col-sm-2">
