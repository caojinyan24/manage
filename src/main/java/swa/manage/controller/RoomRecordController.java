...
////        PageQuery<RoomRecord> pageQuery = new PageQuery<RoomRecord>();
////        pageQuery.setPageNo(pageNo);
////        pageQuery.setPageSize(pageSize);
////        ModelAndView mav = new ModelAndView();
////        pageQuery.setQuery(query);
////        mav.addObject("query", query);
////        mav.setViewName("pay/roomRecordIndex");
////        mav.addObject("pageInfos", SystemTools.convertPaginatedList(roomRecordService.queryRoomRecordPageList(pageQuery)));
////        return mav;
//        return null;
//    }
//
...
////        ModelAndView mav = new ModelAndView();
////        mav.setViewName("pay/roomRecordDetail");
...
//        return "pay/roomRecordAddDialog";
//    }
//
////    /**
////     * 保存信息
