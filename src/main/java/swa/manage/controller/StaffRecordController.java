...
//        PageQuery<StaffRecord> pageQuery = new PageQuery<StaffRecord>();
//        pageQuery.setPageNo(pageNo);
//        pageQuery.setPageSize(pageSize);
//        ModelAndView mav = new ModelAndView();
//        pageQuery.setQuery(query);
//        mav.addObject("query", query);
//        mav.setViewName("pay/staffRecordIndex");
//        mav.addObject("pageInfos", SystemTools.convertPaginatedList(staffRecordService.queryStaffRecordPageList(pageQuery)));
//        return mav;
        return null;
    }
    ...
    public ModelAndView staffRecordDetail(@RequestParam(required = true, value = "id") Long id) {
        ModelAndView mav = new ModelAndView();
        mav.setViewName("pay/staffRecordDetail");
    ...
    public String toAddDialog(HttpServletRequest request, ModelMap model) {
        return "pay/staffRecordAddDialog";
    }
